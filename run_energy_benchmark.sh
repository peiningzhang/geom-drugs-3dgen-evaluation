...
# 输入文件路径（默认是 ../VEDA/outputs/predictions.sdf，如果传了参数就用参数）
INPUT_SDF=${1:-../VEDA/outputs/predictions.sdf}
...
python -u scripts/energy_benchmark/xtb_optimization_multi_process.py \
    ...
    --init_sdf saved_initial_structures.sdf >> "$LOG_FILE" 2>&1
